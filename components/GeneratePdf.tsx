...
//   doc.text("JICOHSAT UNIVERSITY", 105, 20, { align: "center" });
//   doc.setFontSize(14);
...
//   doc.setFont("helvetica", "bold");
//   doc.text("1. PERSONAL INFORMATION", 15, 60);
...
//   doc.setFontSize(12);
//   doc.setFont("helvetica", "bold");
//   doc.text("3. PROGRAM SELECTION", 15, (doc as any).lastAutoTable.finalY + 15);

//   const programInfo = [
//     ["Program:", data.program],
//     ["Concentration:", data.concentration || "N/A"],
...
//   doc.setFontSize(12);
//   doc.setFont("helvetica", "bold");
//   doc.text("4. HEALTH INFORMATION", 15, (doc as any).lastAutoTable.finalY + 15);
...
//   doc.setFontSize(12);
//   doc.setFont("helvetica", "bold");
//   doc.text("5. DOCUMENTS ATTACHED", 15, (doc as any).lastAutoTable.finalY + 15);
...
//  // Footer and Signature
//   let currentY = (doc as any).lastAutoTable.finalY + 20; // Initialize currentY after the last table
...
//     doc.text(`Program: ${data.program}`, 15, currentY + 40);
//     doc.text(`Concentration: ${data.concentration || "N/A"}`, 15, currentY + 50); // Added fallback for concentration
//     doc.text(`Venue: ${data.screeningLocation}`, 15, currentY + 60); // Adjusted Y for venue

//     doc.setFont("helvetica", "normal");
//     doc.text(
//       "Please bring this document and a valid ID to your screening session.",
//       15,
//       currentY + 70 // Adjusted Y for final instruction
//     );
//   }

//   // Save the PDF
//   doc.save(`JICOHSAT_Application_${data.firstName}_${data.lastName}.pdf`);
